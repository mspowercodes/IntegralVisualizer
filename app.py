...
# Using format="%g" removes trailing zeros from the input boxes
...
# Formatting labels to strip trailing zeros
a_disp = f"{a:g}"
b_disp = f"{b:g}"
...
if y_curve is not None:
    ...
    # Show results with 2 decimal places and stripped zeros
